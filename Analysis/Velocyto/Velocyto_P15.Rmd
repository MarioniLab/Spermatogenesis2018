...
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, 
        encoding = encoding, output_file = '../../../../Dropbox (Cambridge University)/SST_Spermatocytes/Analysis/Vaelocyto/P15.html') })
---
...
library(Rtsne)
library(scater)
loom.data <- read.loom.matrices("../../../../Dropbox (Cambridge University)/SST_spermatocytes/Analysis/Velocyto/do17828.loom")

# Load filtered counts
sce <- readRDS("../../../../Dropbox (Cambridge University)/SST_spermatocytes/Analysis/data/10X_data/SCE_all.rds")
sce <- sce[,grepl("P15", sce$Sample)]
sce <- normalize(sce)

spliced.dat <- loom.data$spliced
spliced.dat <- spliced.dat[,intersect(paste("do17828:", sub("-1", "x", sce$Barcode), sep = ""),

...
saveRDS(file=paste("../../../../Dropbox (Cambridge University)/SST_spermatocytes/Analysis/CnR/DB/H3K27ac/H3K27ac", day, "_1000kb_bins_normReads.rds", sep = ""), list(windows=rowRanges(out), 
    normReads=adjc)) 
```

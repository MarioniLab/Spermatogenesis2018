...
```{r}
bam.files <- list.files("/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/CnR/bam/H3K27ac/", full.names = TRUE,
                        pattern = "*.bam$")
```
...
```{r}
saveRDS(file="/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/CnR/DB/H3K27ac/H3K27ac_1000.rds", list(windows=rowRanges(filtered), 
    DB=out)) 
```
...
saveRDS(file="../../../../Dropbox (Cambridge University)/SST_spermatocytes/Analysis/CnR/DB/H3K9me3/H3K9me3_1000kb_bins_normReads.rds", list(windows=rowRanges(cur_bins), 
    normReads=adjc)) 
```

Save normalized reads in the overlapping windows
...
adjc <- cpm(tmp, log=TRUE, prior.count=0.5)
colnames(adjc) <- paste(treatment, batch, sep = "_")
saveRDS(file="../../../../Dropbox (Cambridge University)/SST_spermatocytes/Analysis/CnR/DB/H3K9me3/H3K9me3_1000kb_windows_normReads.rds", list(windows=rowRanges(out), 
    normReads=adjc)) 
```

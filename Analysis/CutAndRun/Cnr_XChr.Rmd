...
```{r}
pdf("/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/CnR/Results/XChr/GeneExpression.pdf",
...
filenames <- sub(".bed.1-1000.bedgraph.gz$", ".pdf",
                 list.files("/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/CnR/bedgraphs/H3K4me3/"))
...
for(i in 1:length(cur_files)){
  ...
  pdf(paste("/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/CnR/Results/XChr/H3K4me3/", 
            filenames[i], sep = ""),
    width = 10, height = 15, onefile=FALSE)
...
```{r}
cur_files <- list.files("/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/CnR/bedgraphs/H3K9me3/", 
                        full.names = TRUE)
filenames <- sub(".bed.1-1000.bedgraph.gz$", ".pdf",
                 list.files("/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/CnR/bedgraphs/H3K9me3/"))
...
for(i in 1:length(cur_files)){
  ...
  # Flip the tss on minus strand
  # mat.tss[which(strand(tss.X) == "-"),] <- t(apply(mat.tss[which(strand(tss.X) == "-"),], 1, rev))
  pdf(paste("/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/CnR/Results/XChr/H3K9me3/", 
            filenames[i], sep = ""),
    width = 10, height = 15, onefile=FALSE)
  pheatmap(mat.tss[c(rownames(mat.1), rownames(mat.2), rownames(mat.3)),],
           cluster_rows = FALSE, cluster_cols = FALSE, 
...
cur_files <- list.files("/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/CnR/bedgraphs/H3K27ac/", 
                        full.names = TRUE)
filenames <- sub(".bed.1-1000.bedgraph.gz$", ".pdf",
                 list.files("/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/CnR/bedgraphs/H3K27ac/"))
...
for(i in 1:length(cur_files)){
  ...
  # Flip the tss on minus strand
  # mat.tss[which(strand(tss.X) == "-"),] <- t(apply(mat.tss[which(strand(tss.X) == "-"),], 1, rev))
  pdf(paste("/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/CnR/Results/XChr/H3K27ac/", 
            filenames[i], sep = ""),
    width = 10, height = 15, onefile=FALSE)
  pheatmap(mat.tss[c(rownames(mat.1), rownames(mat.2), rownames(mat.3)),],
           cluster_rows = FALSE, cluster_cols = FALSE, 
...
```{r}
cur_files <- list.files("/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/CnR/bedgraphs/H3.3/", 
                        full.names = TRUE)
filenames <- sub(".bed.1-1000.bedgraph.gz$", ".pdf",
                 list.files("/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/CnR/bedgraphs/H3.3/"))
...
for(i in 1:length(cur_files)){
  ...
  # Flip the tss on minus strand
  # mat.tss[which(strand(tss.X) == "-"),] <- t(apply(mat.tss[which(strand(tss.X) == "-"),], 1, rev))
  pdf(paste("/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/CnR/Results/XChr/H3.3/", 
            filenames[i], sep = ""),
    width = 10, height = 15, onefile=FALSE)
  pheatmap(mat.tss[c(rownames(mat.1), rownames(mat.2), rownames(mat.3)),],
           cluster_rows = FALSE, cluster_cols = FALSE, 

...
# Read in data
# Adult
sce.adult <- readRDS("/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/data/10X_data/SCE_all.rds")
...
# Juvenile
sce.juvenile <- readRDS("/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/data/10X_data/SCE_juvenile.rds")
...
# P10
sce.P10 <- readRDS("/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/data/10X_data/SCE_P10.rds")
rowData(sce.P10) <- rowData(sce.P10)[,1:3]

# P35
sce.P35 <- readRDS("/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/data/10X_data/SCE_P35.rds")
...
for(i in cur_groups){
  ...
  for(i in 1:nrow(enriched.GO)){
    allegs = get(enriched.GO$category[i], org.Mm.egGO2ALLEGS)
    genes = unlist(mget(allegs,org.Mm.egSYMBOL))
    genes = as.character(genes[genes %in% markers.P20$Genename])
    all_genes[i] <- paste(genes, collapse = ", ")
  }

...
new.clusters[new.clusters == 21] <- "Fetal_Leydig_2"
new.clusters[new.clusters == 22] <- "Interstitial_tMg"
new.clusters[new.clusters == 23] <- "Fetal_Leydig_1"
new.clusters[new.clusters == 24] <- "Fetal_Leydig_3"
new.clusters[new.clusters == 25] <- "Spermatogonia_1"
new.clusters[new.clusters == 26] <- "Spermatogonia_2"

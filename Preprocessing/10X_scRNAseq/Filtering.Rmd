...
# Cst12 - Sertoli, Col4a3 - PTM, Cd14 - tMg, Dlk1 - Immature Leydig, Tm4sf1 - Endothelial cells
```
...
new.clusters[new.clusters == 1] <- "S6"
new.clusters[new.clusters == 2] <- "S5"
new.clusters[new.clusters == 3] <- "Meiosis"
new.clusters[new.clusters == 4] <- "S9"
new.clusters[new.clusters == 5] <- "NA1"
new.clusters[new.clusters == 6] <- "S11"
new.clusters[new.clusters == 7] <- "NA2"
new.clusters[new.clusters == 8] <- "NA3"
new.clusters[new.clusters == 9] <- "NA4"
new.clusters[new.clusters == 10] <- "Spermatogonia"
new.clusters[new.clusters == 11] <- "Immature_Leydig"
new.clusters[new.clusters == 12] <- "Leydig"
new.clusters[new.clusters == 13] <- "Endothelial_cells"
new.clusters[new.clusters == 14] <- "Interstitial_tMg"
new.clusters[new.clusters == 15] <- "Sertoli"
new.clusters[new.clusters == 16] <- "Peritubular_tMg"
new.clusters[new.clusters == 17] <- "Spermatocytes_2"
new.clusters[new.clusters == 18] <- "Spermatocytes_5"
new.clusters[new.clusters == 19] <- "S1"
new.clusters[new.clusters == 20] <- "Spermatocytes_6"
new.clusters[new.clusters == 21] <- "S2"
new.clusters[new.clusters == 22] <- "NA5"
new.clusters[new.clusters == 23] <- "Spermatocytes_3"
new.clusters[new.clusters == 24] <- "PTM"
new.clusters[new.clusters == 25] <- "Spermatocytes_7"
new.clusters[new.clusters == 26] <- "Spermatocytes_4"
new.clusters[new.clusters == 27] <- "S4"
new.clusters[new.clusters == 28] <- "S8"
new.clusters[new.clusters == 29] <- "S3"
new.clusters[new.clusters == 30] <- "Spermatocytes_1"
new.clusters[new.clusters == 31] <- "S13"
new.clusters[new.clusters == 32] <- "S14"
new.clusters[new.clusters == 33] <- "S7"
new.clusters[new.clusters == 34] <- "S10"
new.clusters[new.clusters == 35] <- "Outliers"
new.clusters[new.clusters == 36] <- "S12"
...
colData(sce.all)$AnnotatedClusters <- factor(new.clusters,
      levels = c("Spermatogonia", "Spermatocytes_1",
                 ...
                 "Spermatocytes_5","Spermatocytes_6","Spermatocytes_7","Meiosis", 
                 "S1", "S2", "S3", "S4", "S5", "S6", "S7", "S8", "S9",
                 "S10", "S11", "S12", "S13", "S14", "Sertoli", "Leydig", 
                 "Immature_Leydig", "PTM", "Endothelial_cells", 
                 "Interstitial_tMg", "Peritubular_tMg", "NA1", "NA2", 
                 "NA3","NA4","NA5","NA6","Outliers"))

...
new.vector.somatic[new.vector.somatic == 16] <- "Adult_sertoli"
new.vector.somatic[new.vector.somatic == 17] <- "Fetal_sertoli"
...
colData(sce.all)$AnnotatedClusters <- factor(AnnotatedClusters,
      levels = c("Spermatogonia", "Spermatocytes_1",
                 ...
                 "Spermatocytes_5","Spermatocytes_6","Spermatocytes_7", "Spermatocytes_8", 
                 "S1", "S2", "S3", "S4", "S5", "S6", "S7", "S8", "S9",
                 "S10", "S11", "Fetal_sertoli", "Sertoli", "Leydig_1", "Leydig_2", 

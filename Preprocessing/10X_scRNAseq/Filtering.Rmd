...
# Tc1
sce.do15983 <- read10xCounts("../../../../Google Drive File Stream/My Drive/Christina/Tc1_single_cell/data/raw_reads/10X/do15983/Mus_human_chr21/")
...
new.clusters[new.clusters == 5] <- "Outliers"
new.clusters[new.clusters == 6] <- "S11"
new.clusters[new.clusters == 7] <- "Outliers"
new.clusters[new.clusters == 8] <- "Outliers"
...
new.clusters[new.clusters == 16] <- "Outliers"
...
new.clusters[new.clusters == 22] <- "Outliers"
...
```{r}
writeMM(counts(sce.all), "../../../../Dropbox (Cambridge University)/SST_spermatocytes/ArrayExpress/10X/raw_counts.mtx")
write.table(colData(sce.all), "../../../../Dropbox (Cambridge University)/SST_spermatocytes/ArrayExpress/10X/cell_metadata.txt")
```

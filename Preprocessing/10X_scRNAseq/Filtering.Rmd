...
new.clusters[new.clusters == 16] <- "Immature_Leydig2"
...
new.clusters[new.clusters == 24] <- "tMg"
...
colData(sce.all)$AnnotatedClusters <- factor(new.clusters,
      levels = c("Spermatogonia", "Spermatocytes_1",
                 ...
                 "Immature_Leydig", "Immature_Leydig2", "PTM", "Endothelial_cells", 
                 "tMg", "NA1", "NA2", "NA3","NA4","NA5","NA6","Outliers"))

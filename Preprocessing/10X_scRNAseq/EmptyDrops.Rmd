...
ggplot(data.frame(tsne1 = reducedDims(sce.P15)$TSNE[,1],
                  tsne2 = reducedDims(sce.P15)$TSNE[,2],
                  gene = logcounts(sce.P15)[rowData(sce.P15)$ID[rowData(sce.P15)$Symbol == "Lgals1"],])) +
  geom_point(aes(tsne1, tsne2, colour = gene)) + scale_colour_viridis()

annotatedCluster <- clusters
annotatedCluster[annotatedCluster == 1] <- "Immature_Leydig"
annotatedCluster[annotatedCluster == 2] <- "Sertoli_1"
annotatedCluster[annotatedCluster == 3] <- "Leptotene"
annotatedCluster[annotatedCluster == 4] <- "PTM"
annotatedCluster[annotatedCluster == 5] <- "Spermatocytes"
annotatedCluster[annotatedCluster == 6] <- "Interstitial_tMg_1"
annotatedCluster[annotatedCluster == 7] <- "Undifferentiated_Spermatogonia"
annotatedCluster[annotatedCluster == 8] <- "Endothelial_cells"
annotatedCluster[annotatedCluster == 9] <- "Sertoli_2"
annotatedCluster[annotatedCluster == 10] <- "Interstitial_tMg_2"
annotatedCluster[annotatedCluster == 11] <- "Leydig"
annotatedCluster[annotatedCluster == 12] <- "Zygotene"
annotatedCluster[annotatedCluster == 13] <- "Differentiating_Spermatogonia"


colData(sce.P15)$AnnotatedClusters <- factor(annotatedCluster,
      levels = c("Undifferentiated_Spermatogonia", "Differentiating_Spermatogonia",
                 "Leptotene","Zygotene","Spermatocytes",
                 "Immature_Leydig","Leydig","Sertoli_1","Sertoli_2", 
                 "PTM", "Interstitial_tMg_1", "Interstitial_tMg_2", "Endothelial_cells"))

colour_vector <- c("Undifferentiated_Spermatogonia" = "#00441b", 
                   "Differentiating_Spermatogonia" = "#238b45",
                   "Leptotene" = "#d4b9da",
                   "Zygotene" = "#FBDCEA",
                   "Spermatocytes" = "#F2B2D1",
                   "Sertoli_1" = "#643F18",
                   "Sertoli_2" = "sienna4",
                   "Leydig" = "#985D25",
                   ...
                   "Interstitial_tMg_1" = "#F36E20",
                   "Interstitial_tMg_2" = "darkorange3")
...
Lep.Zygot.markers <- marker.detection(sce.P15, 
                                  as.character(colData(sce.P15)$AnnotatedClusters))

...
```{r filtering}
# Merge datasets
sce.all.1 <- cbind(sce.do17815, sce.do17816, sce.do17821, sce.do18195)
sce.all.2 <- cbind(sce.do17824, sce.do18196, sce.do17825, sce.do17827)
rm("sce.do17815")
rm("sce.do17816")
rm("sce.do17821")
rm("sce.do18195")
...
colData(sce.all)$P15Clusters <- factor(P15.clusters,
      levels = c("Undifferentiated_Spermatogonia", "Differentiating_Spermatogonia",
                 "Leptotene","Zygotene","Spermatocytes",
                 "Immature_Leydig","Leydig","Sertoli_1","Sertoli_2", 
                 "PTM", "Interstitial_tMg_1", "Interstitial_tMg_2", "Endothelial_cells", NA))

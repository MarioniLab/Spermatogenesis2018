...
# Tc0
sce.do15984 <- read10xCounts("../../../../Google Drive File Stream/My Drive/Christina/Tc1_single_cell/data/raw_reads/10X/do15984/raw_gene_bc_matrices/Mus_human_chr21/")
colData(sce.do15984)$Sample <- rep("Tc0", ncol(sce.do15984))
colData(sce.do15984)$Library <- rep("do15984", ncol(sce.do15984))

sce.do17622 <- read10xCounts("../../../../Google Drive File Stream/My Drive/Christina/Tc1_single_cell/data/raw_reads/10X/do17622/raw_gene_bc_matrices/Mus_human_chr21/")
colData(sce.do17622)$Sample <- rep("Tc0", ncol(sce.do17622))
colData(sce.do17622)$Library <- rep("do17622", ncol(sce.do17622))

sce.do18199 <- read10xCounts("../../../../Google Drive File Stream/My Drive/Christina/Tc1_single_cell/data/raw_reads/10X/do18199/raw_gene_bc_matrices/Mus_human_chr21/")
colData(sce.do18199)$Sample <- rep("Tc0", ncol(sce.do18199))
colData(sce.do18199)$Library <- rep("do18199", ncol(sce.do18199))

# Tc1
sce.do15983 <- read10xCounts("../../../../Google Drive File Stream/My Drive/Christina/Tc1_single_cell/data/raw_reads/10X/do15983/raw_gene_bc_matrices/Mus_human_chr21/")
colData(sce.do15983)$Sample <- rep("Tc1", ncol(sce.do15983))
colData(sce.do15983)$Library <- rep("do15983", ncol(sce.do15983))

sce.do17623 <- read10xCounts("../../../../Google Drive File Stream/My Drive/Christina/Tc1_single_cell/data/raw_reads/10X/do17623/raw_gene_bc_matrices/Mus_human_chr21/")
colData(sce.do17623)$Sample <- rep("Tc1", ncol(sce.do17623))
colData(sce.do17623)$Library <- rep("do17623", ncol(sce.do17623))

sce.do18197 <- read10xCounts("../../../../Google Drive File Stream/My Drive/Christina/Tc1_single_cell/data/raw_reads/10X/do18197/raw_gene_bc_matrices/Mus_human_chr21/")
colData(sce.do18197)$Sample <- rep("Tc1", ncol(sce.do18197))
colData(sce.do18197)$Library <- rep("do18197", ncol(sce.do18197))

sce.do18198 <- read10xCounts("../../../../Google Drive File Stream/My Drive/Christina/Tc1_single_cell/data/raw_reads/10X/do18198/raw_gene_bc_matrices/Mus_human_chr21/")
...
is.cell <- empty.droplets$FDR <= 0.01
is.cell[is.na(is.cell)] <- FALSE
sce.do18196.empty <- sce.do17824[,!is.cell]

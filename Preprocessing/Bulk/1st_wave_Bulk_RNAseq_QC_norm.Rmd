...
```{r}
# Load reads
raw_counts <- read.table("/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/data/bulk/raw/1st_wave_bulk_all_reverse-stranded.txt", sep = "\t")
...
saveRDS(norm, "/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/data/bulk/norm/1st_wave_bulk_norm_reverse-stranded.rds")
```
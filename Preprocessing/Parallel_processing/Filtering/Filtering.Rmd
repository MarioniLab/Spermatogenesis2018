...
rowData(sce.do17821) <- rowData(sce.do17821)[,c("ID", "Symbol")]
```
...
rowData(sce.do17827) <- rowData(sce.do17827)[,c("ID", "Symbol")]
```

# Filtering on remaining samples

```{r Other}
# Merge reamining datasets
sce.rest <- cbind(sce.do17815, sce.do17816, sce.do15984, sce.do17622, 
                  sce.do15983, sce.do17623, sce.do17824, sce.do17825, 
                  sce.do17828)

# Calculate QC metrics
sce.rest <- calculateQCMetrics(sce.rest)

# Remove cells with few features
plot(colData(sce.rest)$total_counts, colData(sce.rest)$total_features, log = "x", pch = 16, 
     xlab = "Total counts", ylab = "Number of genes", 
     col = ifelse(colData(sce.rest)$total_features > 2000, "black", "red"))
sce.rest <- sce.rest[,colData(sce.rest)$total_features > 2000]

rowData(sce.rest) <- rowData(sce.rest)[,c("ID", "Symbol")]
```

# Merge data and further QC

```{r further_filtering}
sce.all <- cbind(sce.rest, sce.do17821, sce.do17827)

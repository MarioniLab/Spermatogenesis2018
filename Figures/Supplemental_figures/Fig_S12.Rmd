...
df <- data.frame(Spermatocytes.K9.P24 = rowMeans(cur_rpm.K9.P24[,c(1,3)]),
                 ...
                 Spermatocytes.K27.P26 = rowMeans(cur_rpm.K27.P26[,c(1,3)]),
...
spermatid.spec <- read.xlsx("../../../../Dropbox (Personal)/Tc1_meiotic_silencing/Revisions/Figures/Supplemental Tables/Table_S11.xlsx")

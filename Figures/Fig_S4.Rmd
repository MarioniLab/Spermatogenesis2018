...
pca <- prcomp(t(logcounts(sce.spermatogonia)))
ggplot(data.frame(tsne1 = pca$x[,1],
                  tsne2 = pca$x[,2],
...
clusters[clusters == 1] <- "Gonocytes"
clusters[clusters == 2] <- "Diff_1"
clusters[clusters == 3] <- "Undiff_2"
clusters[clusters == 4] <- "Diff_2"
clusters[clusters == 5] <- "Diff_3"
clusters[clusters == 6] <- "Preleptotene"
clusters[clusters == 7] <- "Undiff_1"
...
for.heatmap <- logcounts(sce.spermatogonia)[match(sperm.markers$GeneName, 

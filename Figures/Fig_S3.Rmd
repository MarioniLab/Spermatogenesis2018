...
top.markers <- unlist(lapply(somatic.markers, function(n){n$GeneName[1:5]}))

# Genes to visualize
genes <- c("Cst12", top.markers[1:5],  
           "Sycp1", top.markers[6:10] "Dmrt1", "Dlk1", "Col4a3", "Tm4sf1", "Insl3", "Cd14",
           "Sbno1", "H2-D1")

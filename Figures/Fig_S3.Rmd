...
emptyDrops.Sycp1 <- ggplot() +
  geom_point(data = df2, aes(tsne1, tsne2, colour = Sycp1)) +
  geom_point(data = df1, aes(tsne1, tsne2, colour = Sycp1)) +
  scale_color_viridis()

emptyDrops.H2afx <- ggplot() +
  geom_point(data = df2, aes(tsne1, tsne2, colour = H2afx)) +
  geom_point(data = df1, aes(tsne1, tsne2, colour = H2afx)) +
  scale_color_viridis()

emptyDrops.Hormad1 <- ggplot() +
  geom_point(data = df2, aes(tsne1, tsne2, colour = Hormad1)) +
  geom_point(data = df1, aes(tsne1, tsne2, colour = Hormad1)) +
  scale_color_viridis()

# Number of genes expressed
emptyDrops.no.genes <- ggplot() +
  geom_point(data = df2, aes(tsne1, tsne2, colour = no.genes)) +
  geom_point(data = df1, aes(tsne1, tsne2, colour = no.genes)) +
...
```{r save}
final <- plot_grid(Nanos3, Stra8, Rhox13,
                   emptyDrops, emptyDrops.P20, NULL,
                   emptyDrops.Sycp1, emptyDrops.H2afx, emptyDrops.Hormad1,
                   emptyDrops.no.genes, NULL, NULL, ncol = 3, nrow = 4)

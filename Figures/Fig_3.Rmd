...
sce.spermatogonia <- sce[,grepl("P10|P15|P20", colData(sce)$Sample) &
...
clusters[clusters == 3] <- "Preleptotene"
clusters[clusters == 4] <- "Undiff_1"
clusters[clusters == 5] <- "Undiff_2"
clusters[clusters == 6] <- "Diff_1"
...
```{r save}
B <- plot_grid(Nanos3, Stra8, Dmrtb1, p.clusters, samples, ncol = 5, nrow = 1)

ggsave("../../../Dropbox (Cambridge University)/SST_spermatocytes/Revisions/Results/New_figures/Fig_3.pdf",
       B, width = 25, height = 5)
```
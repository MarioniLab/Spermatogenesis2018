...
```{r final}
final <- plot_grid(spermatocytes.p, ncol = 1, nrow = 2, rel_heights = c(1,3))
ggsave(filename = "/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/Figures/Fig_3/Fig_3.pdf", final, width = 8, height = 10)
```

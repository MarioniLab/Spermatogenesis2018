...
x.21.inactivation <- ggplot(df) + geom_boxplot(aes(groups, ratios, fill = chr)) + 
  scale_fill_jama() + ylab("Chr:Autosome ratio") + 
    theme(panel.background = element_blank(), axis.title.x = element_blank(),
        axis.text.x = element_text(angle = 45, size = 12, hjust = 1),
        axis.text.y = element_text(size = 12))
ggsave(filename = "/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/Figures/Fig_5/21dynamics.pdf", 
...
epsilons <- readRDS("/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/10X/Variability/data/epsilons_Tc1.rds")
...
x.21.variability <- ggplot(df) + geom_boxplot(aes(Var2, value, fill = chr)) + 
  scale_fill_jama() + ylab("Variabilty") + 
    theme(panel.background = element_blank(), axis.title.x = element_blank(),
        axis.text.x = element_text(angle = 45, size = 12, hjust = 1),
        axis.text.y = element_text(size = 12))
ggsave(filename = "/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/Figures/Fig_6/21variability.pdf", 
       x.21.inactivation, width = 12, height = 7)
```
...
pdf("/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/Figures/Fig_6/Chr21_GeneExpression.pdf", onefile=FALSE)
...
ggsave(filename = "/Users/nils/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/Figures/Fig_6.pdf", final, width = 8, height = 8)
```

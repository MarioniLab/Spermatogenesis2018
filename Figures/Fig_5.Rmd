...
Hist.all <- read.xlsx("../../../Dropbox (Cambridge University)/SST_spermatocytes/Analysis/Figures/Fig_5/Mouse_histones.xlsx")
...
ggsave("../../../Dropbox (Cambridge University)/SST_spermatocytes/Analysis/Figures/Fig_5/NoGenes.pdf", 
...
pdf("../../../Dropbox (Cambridge University)/SST_spermatocytes/Analysis/Figures/Fig_5/Fig_5_TranscriptionalShotdown.pdf", onefile = FALSE)
...
cors$group <- groups
cors <- cors[order(cors$rho, decreasing = TRUE),]
write.xlsx(cors, "../../../Dropbox (Personal)/Tc1_meiotic_silencing/Figures/Supplemental Tables/Table_S7.xlsx")
```
...
infertility <- read.xlsx("../../../Dropbox (Cambridge University)/SST_spermatocytes/Analysis/Figures/Fig_5/male_infertility.xlsx")
```

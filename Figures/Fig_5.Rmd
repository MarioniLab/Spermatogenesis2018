...
ggsave(filename = "/Users/eling01/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/Figures/Fig_5/Xdynamics.pdf", 
...
mat.for.heatmap <- mat.for.heatmap[order(rowMeans(mat.for.heatmap), decreasing = TRUE),]
...
```{r}
pdf("/Users/eling01/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/Figures/Fig_5/GeneExpression.pdf",
...
cur_files <- list.files("/Users/eling01/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/CnR/bedgraphs/H3K4me3/", 
                        full.names = TRUE)
filenames <- list.files("/Users/eling01/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/CnR/bedgraphs/H3K4me3/", 
                        full.names = FALSE)
...
for(i in 1:length(cur_files)){
  ...
  pdf(paste("/Users/eling01/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/Figures/Fig_5/", 
...
for(i in 1:length(cur_files)){
  ...
  pdf(paste("/Users/eling01/Dropbox (Cambridge University)/SST_spermatocytes/Analysis/Figures/Fig_5/", 
          filenames[i], sep = ""), width = 10, height = 15, onefile=FALSE)
  print(EnrichedHeatmap(cur_mat, col = c("white", "green", "black"), 
                  split = c(rep(1, nrow(mat.1)), rep(2, nrow(mat.2)), rep(3, nrow(mat.3))),
                  top_annotation = HeatmapAnnotation(lines = anno_enriched(gp = gpar(col = 2:4)))))
  dev.off()
}
...
# Visualize these genes in bulk data

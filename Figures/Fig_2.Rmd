...
```{r, visualization}
cur_df <- proportions[c("B6", "P15", "P20", "P25", "P30", "P35"),1:23]
cur_df.melt <- melt(cur_df)
levels(cur_df.melt$sample) <- rev(c("B6", "P15", "P20", "P25", "P30", "P35"))
...
# Save plot
ggsave(filename = "../../../Dropbox (Cambridge University)/SST_spermatocytes/Analysis/Figures/Fig_2/ProportionsPlot.pdf", proportions.p,
       width = 180, units = "mm", height = 80)
```

...
# Sum across immature Leydig cells
proportions <- cbind(proportions, rowSums(proportions[,grepl("Immature_Leydig", colnames(proportions))]))
proportions <- proportions[c("B6", "P5", "P10", "P15", "P20", "P25", "P30", "P35"),
                           c(32, 24, 23, 1:22)]
colnames(proportions)[1] <- "Immature_Leydig" 
```
...
proportions.p <- ggplot(cur_df.melt) + 
  ...
  scale_fill_manual(values = c(metadata(sce.all)$color_vector,
        "Immature_Leydig" = as.character(metadata(sce.all)$color_vector["Immature_Leydig_1"]))) + 

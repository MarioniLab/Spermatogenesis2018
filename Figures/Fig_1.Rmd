...
write.xlsx(sperm.markers, "../../../Dropbox (Personal)/Tc1_meiotic_silencing/Figures/Supplemental Tables/Table_S1.xlsx")
```
...
final <- plot_grid(final.1, p.cells, ncol = 2, nrow = 1, rel_widths = c(2,1), 
                   labels = c("D", "E"), label_size = 16)
ggsave("../../../Dropbox (Cambridge University)/SST_spermatocytes/Analysis/Figures/Fig_1/Fig_1.pdf",
       final, units = "mm", width = 300, height = 90)
```
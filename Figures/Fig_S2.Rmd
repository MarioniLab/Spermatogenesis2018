...
```{r final}
A <- plot_grid(adult.batches, P5.batches, ncol = 2, nrow = 1)
B <- plot_grid(plot.list[[1]], plot.list[[2]], plot.list[[3]],
                   plot.list[[4]], plot.list[[5]], plot.list[[6]], ncol = 3, nrow = 4)
final <- plot_grid(A, B, nol = 1, nrow = 2, rel_heights = c(1,2))
ggsave(filename = "../../../Dropbox (Cambridge University)/SST_spermatocytes/Revisions/Results/New_figures/Fig_S2.pdf", 

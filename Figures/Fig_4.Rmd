...
markers <- data.frame(symbol = unlist(lapply(Lep.Zygot.markers, 
                                             function(n){n[1:5,"GeneName"]})),
                      ID = unlist(lapply(Lep.Zygot.markers, 
                                             function(n){rownames(n)[1:5]})),
                      group = rep(names(Lep.Zygot.markers), each = 5))
...
pheatmap(for.heatmap, 
         ...
         scale = "row", 
         show_colnames = FALSE, gaps_row = seq(5,30, 5),

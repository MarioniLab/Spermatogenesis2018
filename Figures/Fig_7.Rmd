...
spermatid.specific <- read.xlsx("../../../Dropbox (Personal)/Tc1_meiotic_silencing/Figures/Supplemental Tables/Table_S8.xlsx")
...
# Annotate genenames
df$spermatid_specific <- df$Symbol %in%
  spermatid.specific$Symbol[spermatid.specific$spermatid_specific]
df$Rnf8 <- df$Symbol %in% K27writers.Rnf8$gene_id
df$Scml2 <- df$Symbol %in% K27writers.Scml2$gene_id

# Plot results
spermatid.spec.K9.spermatocytes <- ggplot(df) + geom_boxplot(aes(spermatid_specific,
...
spermatid.spec.K9.spermatids <- ggplot(df) + geom_boxplot(aes(spermatid_specific,
...
spermatid.spec.K4.spermatocytes <- ggplot(df) + geom_boxplot(aes(spermatid_specific,
...
spermatid.spec.K4.spermatids <- ggplot(df) + geom_boxplot(aes(spermatid_specific,
...
wilcox.test(df$Spermatids.K9[df$spermatid_specific == TRUE],
            df$Spermatids.K9[df$spermatid_specific == FALSE])

wilcox.test(df$Spermatocytes.K4[df$spermatid_specific == TRUE],
            df$Spermatocytes.K4[df$spermatid_specific == FALSE])

wilcox.test(df$Spermatids.K4[df$spermatid_specific == TRUE],
            df$Spermatids.K4[df$spermatid_specific == FALSE])
...
collected.K4 <- collected.K4[c(1,3,2,4)]
  ...
  pdf(paste("../../../Dropbox (Cambridge University)/SST_spermatocytes/Analysis/Figures/Fig_7/Cypt1_forFigure_spermatocytes.pdf", 
            sep = ""),
      width = 12, height = 7)
  plotTracks(c(gax, c(collected.K9[1:2], collected.K4[1:2]),
                                    GeneRegionTrack(gr)),
...
pdf(paste("../../../Dropbox (Cambridge University)/SST_spermatocytes/Analysis/Figures/Fig_7/Cypt1_forFigure_spermatids.pdf", 
            sep = ""),
      width = 12, height = 7)
  plotTracks(c(gax, c(collected.K9[3:4], collected.K4[3:4]),
                                    GeneRegionTrack(gr)),

...
shinyUI(fluidPage(
  ...
  # Application title
  titlePanel("Tsne representation of spermatogenesis (EmptyDrops)"),
  
  sidebarLayout(
    sidebarPanel(
      helpText("This shiny App visualizes the EmptyDrops filtered cells.",
               "The usage is the same as the shiny App visualising the cellranger",
               "filtered cells."),
